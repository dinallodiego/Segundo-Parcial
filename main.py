...
while flag_jugar:
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                ...
                if rayos_disparados < max_rayos:
                    ...
                    nuevo_poder = Poder(pos_horizontal_personaje, pos_vertical_personaje)
    ...
    vidas_text = fuente_vidas.render(f"Vidas: {vidas_personaje}", True, BLANCO)
    ...
    pantalla_ppal.blit(vidas_text,(600,10))
